...
class OWCityscapesInstanceEvaluator(OWCityscapesEvaluator):
    ...
    def process(self, inputs, outputs):
        ...
        # Modify the use of "name2label" to be compatible with open-vocabulary 
        new_classname_to_id = {}
        for label_name in name2label:
            for newname in self._metadata.thing_classes:
                if label_name in newname:
                    new_classname_to_id[newname] = name2label[label_name].id
        # # TODO: Further modify this to be compatible with instance names
                ...
                with open(pred_txt, "w") as fout:
                    for i in range(num_instances):
                        ...
                        try:
                            ...
                            class_id = new_classname_to_id[classes]
                            classes = id2label[class_id].name
