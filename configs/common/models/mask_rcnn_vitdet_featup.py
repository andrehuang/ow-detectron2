...
from detectron2.modeling import ViT, SimpleFeatUpPyramid, SimpleFeatUpPyramid2
...
model.backbone = L(SimpleFeatUpPyramid2)(
    ...
    upsampler_path="/mnt/haiwen/pretrained_models/FeatUp/checkpoints/pixelimplicit_sam_hr/HR_896_n_freqs_20_EMA_True_pretrained_True_crop_upsampler_True_vitdet_pixelimplicit_saccade_False_sam_reg_0.5_sam_hr_alpha_0.8_sam_hr_reg_0.0_sa1b_attention_crf_0.001_ent_0.0_tv_0.0_rec_1.0a100_2.ckpt",
